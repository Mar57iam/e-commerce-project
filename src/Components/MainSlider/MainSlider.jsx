...
import slide6 from '../../assets/grocery-banner-2.jpeg'
...
export default function MainSlider() {
  ...
  return (
    <>
      ...
      <img src={slide6} className='w-full h-[400px] object-cover' alt="" />
